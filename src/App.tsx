...
export const App = () => {
  ...
  const submit = () => {
    window.gtag('event', 'may_and_engage_var5');
    setLoading(true);
      ...
      <>
        <div className={appSt.container}>
          <div className={appSt.textTitle}>
            ...
            <Typography.Text
              ...
              onClick={() => {
                window.gtag('event', 'may_and_what_is_var5');
                setStep('init');
              }}
            >
        ...
        <div className={appSt.bottomBtn}>
          <ButtonMobile
            ...
            view="secondary"
            onClick={() => {
              window.gtag('event', 'may_and_combination_var5');
    ...
    <>
      ...
      <div className={appSt.bottomBtn}>
        <ButtonMobile
          ...
          view="primary"
          onClick={() => {
            window.gtag('event', 'may_and_luck_var5');
            setStep('numbers');
          }}
        >
